...
cout<<"Enter the epochs to go: ";
cin>>epochs_to_go;


  while ((correct_guesses<4) && (cycles<epochs_to_go))
...
DECIMAL energy = error_energy(error);
cout<<"The error energy was "<<energy<<endl<<endl;
  return EXIT_SUCCESS;
}
